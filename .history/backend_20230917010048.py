...
def save_captions():
    ...
    for i in range(len(captions)):
        with open(file_paths[i], "r") as f:
            ...
            post_data = json.loads(requests.get(f'https://scorestream.com/api?request=%7B%22method%22:%22games.posts.add%22,%22params%22:%7B%22accessToken%22:%2267556df4-85ad-48f3-8e51-418a9d5af78d%22,%22gameId%22:{game_id},%22userText%22:%22{}%22%7D%7D', files=files).text)
